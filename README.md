...
Beside the canvas is a [Results tab](docs/python-console.md): a notebook about the drawn network, opening and saving real `.ipynb` files, with a Python prompt in the console pane below sharing its names.
